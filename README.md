...
| POST   | `/invite/{token}/feedback`        | public      | Optional feedback on a finished sitting (rating 1-5, difficulty, comment). **404** until they have submitted something, **409** on a second send. |
